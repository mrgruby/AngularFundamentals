...
export const appRoutes:Routes = [
    ...
    {path: 'events/:id', component: EventDetailsComponent, resolve: {event:EventResolver}},//This uses a service as a route guard. EventRouteActivatorService returns true if the event with the given id exists.
