...
export class AuthService {
    ...
    checkAuthenticationStatus() {
        ...
        this.http.get('/api/currentIdentity')
            ...
            })).subscribe();//We could also write .subscribe(); here, remove the return, and then write .subscribe(); over in app.component like, this.auth.checkAuthenticationStatus().subscribe();
    }
